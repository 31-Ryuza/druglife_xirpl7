  ...
  <!--sidebar start-->
    ...
    <li class="d-flex align-items-center justify-content-center">
        <a class="nav-link">
		 ...
		 <li class="nav-item ">
        <a class="nav-link">
      <div class="d-flex align-items-center justify-content-center" class="name"> <span class="text-success fw-bold" ><?php echo  $data['nama'];?></span></div>
		 <div class="d-flex align-items-center justify-content-center" class="email"> <span class="fst-italic"><?php echo $data['level'];?></span></div>	
		 </a>
      </li>
      ...
      <!-- Heading -->
      <div class="sidebar-heading">
      <span class="text-success" >Pilih Menu</span>
      </div>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
                    ...
                    <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                        ...
                        <a class="dropdown-item" href="?page=pengguna&aksi=ubahpengguna1&id=<?php echo $data['id'] ?>">
		      ...
		      <?php
			   ...
			   $aksi = $_GET['aksi'];
				   ...
				   if ($aksi == "") {
				    ...
				    if ($aksi == "ubahpengguna1") {
					   include "page/pengguna/ubahpengguna1.php";
				   }
